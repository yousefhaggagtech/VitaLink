...
const VITAL_CONFIG: Record<VitalId, VitalConfig> = {
  heartRate: {
    ...
    getInsight: (v) =>
      v > 185 ? 'Max Zone' : v > 165 ? 'High Zone' : v > 140 ? 'Active Zone' : 'Recovery',
    getInsightColor: (v) =>
      v > 185 ? '#FF5A5F' : v > 165 ? '#FF6B35' : '#B6FF2E',
  },
  ...
  spO2: {
    ...
    getInsight: (v) =>
      v >= 97 ? 'Optimal' : v >= 94 ? 'Acceptable' : 'Low - Act',
    getInsightColor: (v) =>
      v >= 97 ? '#B6FF2E' : v >= 94 ? '#FFB800' : '#FF5A5F',
  },
  ...
  temperature: {
    ...
    getInsight: (v) =>
      v > 38.5 ? 'Heat Alert' : v > 37.8 ? 'Elevated' : v > 36.5 ? 'Normal' : 'Low',
    getInsightColor: (v) =>
      v > 38.5 ? '#FF5A5F' : v > 37.8 ? '#FFB800' : '#B6FF2E',
  },
  ...
  stress: {
    ...
    getInsightColor: (v) =>
      v > 75 ? '#FF5A5F' : v > 50 ? '#FFB800' : '#B6FF2E',
  },
};
...
export const VitalCard: React.FC<VitalCardProps> = ({ id, value, history }) => {
  ...
  // Format value — temperature shows 1 decimal, others integer
  ...
  return (
    ...
    >
      ...
      <div className="vl-vital__header">
        <span className="vl-vital__icon" style={{ color: cfg.color }}>
          {cfg.icon}
        </span>
      ...
      <div className="vl-vital__value-row">
        <span className="vl-vital__value" style={{ color: cfg.color }}>
          {displayValue}
        </span>
      ...
      {/* ── Insight tag ── */}
      <span className="vl-vital__insight" style={{ color: insightColor }}>
        {insight}
      </span>
